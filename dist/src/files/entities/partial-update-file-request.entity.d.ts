...
declare const PartialUpdateFileRequestEntitySchema: z.ZodObject<{
    ...
    data: z.ZodObject<{
        ...
        status: z.ZodOptional<z.ZodEnum<typeof import("../../files/entities/file.entity").FileStatus>>;
        ...
        fileType: z.ZodOptional<z.ZodEnum<typeof import("../../files/entities/file.entity").FileType>>;
